defmodule Liquex.Filter do
  ...
  ## Examples
      ...
      "Mar 14, 16"
  """
  def date(%Date{} = value, format, _), do: Ruby.strftime(value, format)
  def date(%DateTime{} = value, format, _), do: Ruby.strftime(value, format)
  def date(%NaiveDateTime{} = value, format, _), do: Ruby.strftime(value, format)
